...
import (
	...
	"github.com/Glutenfree69/agentpipeline-operator/internal/controller"
...
func main() {
	...
	// Create the A2A runner for invoking kagent agents.
	kagentBaseURL := os.Getenv("KAGENT_A2A_URL")
	kagentUserID := os.Getenv("KAGENT_USER_ID")
	agentRunner := runner.NewA2ARunner(kagentBaseURL, kagentUserID)

	slog.Info("kagent A2A runner configured",
